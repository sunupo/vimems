...
public class MutiplayerTrainingModePageAdapter extends FragmentPagerAdapter {

    private List<Fragment> fragmentList;
    private static final String[] tabTitle=Constants.MULTIPLAYER_TRAINING_MODE;
    public MutiplayerTrainingModePageAdapter(FragmentManager fm, List<Fragment> fragmentList) {
        super(fm);
