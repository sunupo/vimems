...
import com.vimems.Adapter.ScanResultAdapter;
import com.vimems.R;
...
public class ScannerFragment extends ListFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        /**
         * 返回 自己的fragment的布局
         * return inflater.inflate(R.layout.some_fragment_layout,container,false);*/
        //因为是继承自ListFragment类，所以使用了ListFragment类中重写的onCreateView方法
